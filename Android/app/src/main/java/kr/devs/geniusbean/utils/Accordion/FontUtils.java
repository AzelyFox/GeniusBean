package kr.devs.geniusbean.utils.Accordion;
...
public class FontUtils {
    ...
    private static void initTypefaces(AssetManager assetsManager) {
        if (normal == null || bold == null || condensed == null || light == null) {
            normal = loadTypeface(assetsManager, "fonts/NanumGothic.otf");
            bold = loadTypeface(assetsManager, "fonts/NanumGothic.otf");
            condensed = loadTypeface(assetsManager, "fonts/NanumGothic.otf");
            light = loadTypeface(assetsManager, "fonts/NanumGothic.otf");
        }
    }

    private static Typeface loadTypeface(AssetManager assetsManager, String path) {
        try {
            return Typeface.createFromAsset(assetsManager, "fonts/NanumGothic.otf");
